...
def open_the_intranet_website():
    ...
    page=browser.page()
    page.goto("https://robotsparebinindustries.com/")
    

def log_in():
    """Fills in the login form and clicks the 'Log in' button"""
    page=browser.page()
    # first_name=page.locator("input[id=username]")
    # password=page.locator("input[id=password]")
    # first_name.fill("maria")
    # password.fill("thoushallnotpass")
    page.fill("#username","maria")
    page.fill("#password","thoushallnotpass")
    # assert first_name.input_value()=="maria"
    # assert password.input_value()=="thoushallnotpass"
